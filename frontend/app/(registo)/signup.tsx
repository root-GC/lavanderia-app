...
export default function Signup() {
  ...
  const handleRegister = async () => {
    if (!name || !email || !telefone || !endereco || !password) {
        ...
        >
          ...
          <View style={styles.formContainer}>
            <View style={styles.inputGroup}>
              <MaterialIcons name="person" size={20} color="#007AFF" style={styles.inputIcon} />
              <TextInput 
            ...
            <View style={styles.inputGroup}>
              <MaterialIcons name="phone" size={20} color="#007AFF" style={styles.inputIcon} />
              <TextInput 
            ...
            <View style={styles.inputGroup}>
              <MaterialIcons name="location-on" size={20} color="#007AFF" style={styles.inputIcon} />
              <TextInput 
